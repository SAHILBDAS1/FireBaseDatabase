package commm.example.iteradmin.firebasedatabase
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val college = findViewById<EditText>(R.id.clg)
        ...
        save.setOnClickListener {
            ...
            val ref:DatabaseReference = database.getReference("user").child("sahil")
